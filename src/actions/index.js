...
export function removeMovieFavorite(id) {
  //payload es solo el id, no payload.id, solo id porque eso le paso cuando lallamo a la action
  return {
...
export function addMovieFavorite(payload) {
  // una pelicula en particular el payload
  return { type: ADD_MOVIE_FAVORITE, payload }; //
}

export function getMovies(titulo) {
  //parametro nombre titanic
